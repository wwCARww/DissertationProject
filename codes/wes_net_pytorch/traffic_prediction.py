...
def main():
    ...
    train_data = LoadData(data_path=["data/test17.csv", "data/test17.npz"], num_nodes=17, divide_days=[700, 29],
                          time_interval=1, history_length=6,
                          train_mode="train")

    train_loader = DataLoader(train_data, batch_size=64, shuffle=True, num_workers=32)

    test_data = LoadData(data_path=["data/test17.csv", "data/test17.npz"], num_nodes=17, divide_days=[700, 29],
                         time_interval=1, history_length=6,
                         train_mode="test")
